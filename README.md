...
Early development — Milestone 1 of 5. What works today:
...
- `--global` machine-level context (`~/.dejavu`) with hard layer separation, enforced in code and tests
...
- **M2 — Inject**: project active decisions into managed blocks in `CLAUDE.md`, `AGENTS.md`, `.cursorrules`, OpenClaw `MEMORY.md`; adapter interface is ~40 lines per tool
